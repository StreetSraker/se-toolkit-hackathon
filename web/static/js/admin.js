...
function displayAdminOrders(orders) {
            ...
            <div class="order-card" onclick="showOrderDetail('${order.id}')" style="cursor: pointer;">
                <div class="order-header">
                    <div>
                        ...
                        <span style="color: #b8c0cc; margin-left: 10px;">— ${carName}</span>
                        <span style="color: #9ca3af; margin-left: 10px;">| ${username}</span>
                    </div>
    ...
    if (orders.length > 10) {
        container.innerHTML += `<p style="text-align: center; color: #9ca3af; margin-top: 20px;">...and ${orders.length - 10} more orders</p>`;
    }
}
